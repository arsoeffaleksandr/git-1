...
<body>
	...
	<main class="container mt-5">
		<div class="row">
			<div class="col-md-8 mb-3">
				...
				<a href="../admin/adminpanel.php"><button class="button btn-success">ДОбавить товар</button></a>
				<a href="adminnews.php"><button class="button btn-success">ДОбавить новость</button></a>
				<?php
					endif;
				?>
			</div>
	...
	<script>
		...
		$('#auth_user').click(function () {
			...
			var pass = $('#pass').val();
			$.ajax({
				url: 'admin/avtadministrator.php',
				type: 'POST',
				cache: false,
